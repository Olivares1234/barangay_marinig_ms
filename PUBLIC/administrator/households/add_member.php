...
<?php include SHARED_PATH.'/administrator_header.php' ?>
			...
			<form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
				...
				<div class="form-group">
					...
					<select name="role_in_the_family" class="form-control">
						...
						<option value="Child">Senior Citizen</option>
	...
	<script type="text/javascript">
		...
		function retrieveResidents(keyword="",offset="0") {
			...
			httpRequest.open("GET","/barangay_marinig_ms/public/administrator/residents/retrieve_available.php?keyword="+encodeURI(keyword) + "&offset=" + encodeURI(offset));
